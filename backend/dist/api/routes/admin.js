...
router.delete("/assessments/:assessmentId/attempts", admin_controller_1.deleteAllAttemptsByAssessment);
router.post("/assessments/:assessmentId/attempts/delete", admin_controller_1.deleteAllAttemptsByAssessment);
...
router.delete("/assessments/:assessmentId", admin_controller_1.deleteAssessment);
router.post("/assessments/:assessmentId/delete", admin_controller_1.deleteAssessment);
